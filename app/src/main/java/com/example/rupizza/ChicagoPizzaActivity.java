/**
 * This is the class for controlling whatever happens in Chicago style
 * Helps order pizza of type chicago style.
...
public class ChicagoPizzaActivity extends AppCompatActivity {
    ...
    /**
     * This is a class that is an instance of creation for Chicago activity.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toppingChoices != null){
            ...
            Toast.makeText(ChicagoPizzaActivity.this,
                    numToppings + "",
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(size == null){
                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(ChicagoPizzaActivity.this);
                ...
                if(!size.equals("") && !type.equals("")){
                    createPizza();
                    android.app.AlertDialog.Builder alertDialog = new AlertDialog.Builder(ChicagoPizzaActivity.this);
                    ...
                    if(size == ""){
                        Toast.makeText(ChicagoPizzaActivity.this, "Must pick size.",
                                Toast.LENGTH_SHORT).show();
                    }
                    if(type == ""){
                        Toast.makeText(ChicagoPizzaActivity.this, "Must pick Type.",
                                Toast.LENGTH_SHORT).show();
                    }
                }
            }
        ...
        listView2.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                ...
                if(type=="Build Your Own"){
                    imageView2.setImageResource(R.drawable.byo);

                }
                else if(type== "BBQ Chicken"){
                    imageView2.setImageResource(R.drawable.bbqckpza);

                }
                else if(type=="Deluxe"){
                    imageView2.setImageResource(R.drawable.deluxe);

                }
                else if(type == "Meatzza"){
                    imageView2.setImageResource(R.drawable.meatzaa);
                }else{
                    imageView2.setImageResource(R.drawable.pcika);
                }
        ...
        if(Chicity == true){
            ...
            if(size.equalsIgnoreCase("Small")|| size.equalsIgnoreCase("Medium")  || size.equalsIgnoreCase("Large")){
                if(type == "BBQ Chicken"){
                    ...
                    imageView2.setImageResource(R.drawable.cheadder);
                }
                else if(type == "Meatzza"){
